/****************************************************************************
** Meta object code from reading C++ file 'com_settingsdialog.h'
**
...
#include "../../data_viewer/com_settingsdialog.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'com_settingsdialog.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 29, 12), // "showPortInfo"
QT_MOC_LITERAL(4, 42, 3), // "idx"
QT_MOC_LITERAL(5, 46, 5), // "apply"
QT_MOC_LITERAL(6, 52, 25) // "checkCustomBaudRatePolicy"

    },
    "SettingsDialog\0updateSignal\0\0showPortInfo\0"
    "idx\0apply\0checkCustomBaudRatePolicy"
};
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsDialog::updateSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SettingsDialog::updateSignal()
{
